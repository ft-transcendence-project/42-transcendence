...
class GameSettingViewTest(TestCase):
    ...
    def test_get(self):
        response = self.client.get(reverse("gamesetting:game_settings_list"), follow=True)
    ...
    def test_post(self):
        ...
        response = self.client.post(reverse("gamesetting:game_settings_list"), data, format='json')
    ...
    def test_put(self):
        ...
        response = self.client.put(reverse("gamesetting:game_settings_detail", kwargs={'pk': self.game_setting.id}), data, format='json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete(self):
        ...
        self.assertEqual(response.status_code, 201)
        self.assertEqual(GameSetting.objects.count(), 2)
        response = self.client.delete(reverse("gamesetting:game_settings_detail", kwargs={'pk': self.game_setting.id}))
